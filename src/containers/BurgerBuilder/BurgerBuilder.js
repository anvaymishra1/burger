...
export class BurgerBuilder extends Component {
  ...
  componentDidMount() {
    axios
      .get("https://react-my-burger-anvay.firebaseio.com/ingredients.json")
      .then((response) => {
  ...
  render() {
    ...
    burger = (
      <Aux>
        <Burger val={this.state.ingredients} />
        <BuildControls
          func1={this.addIngredientHandler}
          func2={this.removeIngredientHandler}
